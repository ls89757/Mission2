...
namespace ComplexNumber
{
    public class ComplexNumber
    {
        ...
        public  ComplexNumber PowerOn(double y)
        {
             
            double chord = Math.Sqrt( imaginary_part* imaginary_part + real_part * real_part);
            Double theta = Math.Asin(imaginary_part / real_part);
